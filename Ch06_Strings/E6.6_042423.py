...
# The documentation uses a syntax that might be confusing. For example, in 'find(sub[, start[, end]]),' the brackets indicate optional
# arguments. So 'sub' is required, but 'start' is optional, and if you include 'start', then 'end' is optional.
